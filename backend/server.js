...
/**
 * Uncomment the code below, activate ChatBox in the footer of App.js and activate SupportWindow in App.js under viewable by admin only
 * localhost works perfectly fine, but the deplyment to heroku gives trouble when using Socket.io
 */
