...
export const ORDER_DEATILS_REQUEST = "ORDER_DETAILS_REQUEST";
export const ORDER_DEATILS_SUCCESS = "ORDER_DETAILS_SUCCESS";
export const ORDER_DEATILS_FAIL = "ORDER_DETAILS_FAIL";
